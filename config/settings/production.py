...
try:
    ...
    ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["pengcrest.com", "www.pengcrest.com", "0.0.0.0", "*", "mail.pengcrest.com"])
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "pengcrest.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "pengcrest.utils.storages.MediaRootS3Boto3Storage"
