...
def run_commands():
    ...
    dokku run -rm pengcrest python manage.py can_withdraw""")
...
schedule.every(1).day.at("16:46").do(run_commands) # run commands every day at 3:30 am
